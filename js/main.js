...
function showDatePicker() {
  ...
  const datepicker = new Datepicker(document.getElementById('datePickerContainer'), {
      autohide: true,
      format: 'yyyy-mm-dd',
      ...
      onSelect: (instance, date) => {
          ...
          // For example, update another element or variable with the selected date
          document.getElementById('selectedDate').innerText = date.toLocaleDateString();
      }
  });
